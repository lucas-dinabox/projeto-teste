...
class SaleSidePanelView extends TPage
{
    ...
    public function onView($param)
    {
        try
        {
            ...
            $label_customer_id = new TLabel('Customer:', '#333333', '16px', 'b');
            $label_obs = new TLabel('Obs:', '#333333', '16px', 'b');
    
            $text_id  = new TTextDisplay($master_object->id, '#333333', '16px', '');
            $text_date  = new TTextDisplay($master_object->date, '#333333', '16px', '');
            $text_total  = new TTextDisplay($master_object->total, '#333333', '16px', '');
            $text_customer_id  = new TTextDisplay(Customer::find($master_object->customer_id)->name, '#333333', '16px', '');
            $text_obs  = new TTextDisplay($master_object->obs, '#333333', '16px', '');
